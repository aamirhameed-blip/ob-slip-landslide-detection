...
> - MLA: Hameed, Aamir, et al. “OB-SLIP: A Terrain-Constrained Object-Based Extension of the SLIP Algorithm for Multi-Sensor Landslide Detection.” 2026.
> - APA: Hameed, A., Confuorto, P., Novellino, A., Lollino, P., & Parise, M. (2026). OB-SLIP: A terrain-constrained object-based extension of the SLIP algorithm for multi-sensor landslide detection. Unpublished manuscript.
> - Harvard: Hameed, A., Confuorto, P., Novellino, A., Lollino, P. and Parise, M. (2026) OB-SLIP: A terrain-constrained object-based extension of the SLIP algorithm for multi-sensor landslide detection. Unpublished manuscript.
